                ...
                <form method="post" action="<?= base_url('Pengaturan/update_level'); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" id="akses" name="akses">
                            ...
                            if ($level->akses_level == "Komisi, Akunting, Persediaan") echo "<option value='Komisi, Akunting, Persediaan' selected>Komisi, Akunting, Persediaan</option>";
                            else echo "<option value='Komisi, Akunting, Persediaan'>Komisi, Akunting, Persediaan</option>";
                            ...
                            if ($level->akses_level == "Persediaan") echo "<option value='Persediaan' selected>Persediaan</option>";
                            else echo "<option value='Persediaan'>Persediaan</option>";
