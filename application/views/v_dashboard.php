...
<div class="container pt-5">
    <div class="d-flex justify-content-start mb-2">
        <?php if ($akses_level != 'Akunting' && $akses_level != 'Persediaan') {?>
            <div class="text-right">
                <a href="<?= base_url('komisi/komisi');?>">
                    <button type="button" class="btn btn-success" data-whatever="@getbootstrap" >Pembagian Komisi</button></a>
                </div>
            <?php } ?>

            <?php if ($akses_level != 'Komisi' && $akses_level != 'Persediaan') {?>
                <?php if ($level_asli == 'Admin Akuntan') {?>
                    <div class="text-right">
                    <?php }else{ ?>
                    ...
                    <div class="text-right">
                     <?php if ($akses_level != 'Komisi' && $akses_level != 'Akunting') {?>
                        <?php if ($level_asli == 'Admin Persediaan') {?>
                            <div class="text-right">
                            <?php }else{ ?>
                                <div class="text-right ml-2">
                                <?php } ?>
                                <a href="<?= base_url('Persediaan');?>">
                                    <button type="button" class="btn btn-danger" data-whatever="@getbootstrap" >Persediaan Barang</button></a>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
