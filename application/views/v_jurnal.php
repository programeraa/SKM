...
<?php if ($hapus_jurnal) { ?>
    ...
    <?php }else{ 
        ...
        <div class="text-right mt-3">
            <a href="<?= base_url('Jurnal/tambah_pesan?tgl_input=' . $waktu_awal . '&tgl_dari=' . $_GET['dari']. '&tgl_ke=' . $_GET['ke']. '&pesan=Buka Jurnal ' . $tampil_bulanku.' '.$tahun_dari . '&bulan=' . $tampil_bulanku . '&admin=' . $id); ?>"
