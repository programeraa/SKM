    ...
    <div class="card">
        <div class="card-header bg-dark text-white">
            ...
            <?php if ($b != null && $trans != null) {?>
                ...
                <div class="col-auto text-center">
                <strong><span class= text-warning>Status ('.$trans.')</span></strong> 
                </div>
            </div>'; ?></h5> 
        <?php }elseif ($b != null && $trans == null) { ?>
            <h5><?php echo '<div class="justify-content-center">
            <div class="col-auto text-center">
            <strong><span class= text-warning>'.$j.' Periode '.date("d-m-Y", strtotime($b)).' sampai '.date("d-m-Y", strtotime($t)).'</span></strong> 
            </div>
        ...
        <tbody>
            ...
            foreach ($komisi as $komisi) { 
                ...
                <tr>
                    ...
                    <td>
                        <?php 
                        if ($komisi->kantor_komisi == 'PUSAT') {
                            echo "<span class='badge badge-primary p-2'>".$komisi->kantor_komisi." - ".$komisi->nomor_kantor_komisi."</span>";
                        } else {
                            echo "<span class='badge badge-success p-2'>".$komisi->kantor_komisi." - ".$komisi->nomor_kantor_komisi."</span>";
                        }
                        ?>
                    </td>
