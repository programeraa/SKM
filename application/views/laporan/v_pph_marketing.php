                ...
                <tr>
                    ...
                    <td>
                        ...
                        if (!in_array($kantor_nomor_key, $unique_kantor_nomor_values)) {
                            ...
                            if ($pph->kantor_komisi == 'PUSAT') {
                                echo "<span class='badge badge-primary p-2'>".$pph->kantor_komisi." - ".$pph->nomor_kantor_komisi."</span>";
                            } else {
                                echo "<span class='badge badge-success p-2'>".$pph->kantor_komisi." - ".$pph->nomor_kantor_komisi."</span>";
                            }
                        }
                        ?>
                    </td>
