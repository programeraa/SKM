<div class="container pt-5 pb-5">
    ...
    <div class="card">
        <div class="card-header bg-dark text-white">
            <h4 class="card-title">Edit Jurnal Ledger</h4>
        </div>
        <div class="card-body">
            <?php 
            foreach ($bank_titipan as $bt) {
                ?>
                <form method="post" action="<?= base_url('BankTitipan/update_ledger'); ?>" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-6">
                        ...
                        <div class="col-md-6">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label for="jenis_lg" class="col-form-label">Jenis Transfer</label>
                                        <select class="form-control" id="jenis_lg" name="jenis_lg">
                                            <option value="">Pilih</option>
                                            <?php
                                            if ($bt->jenis == "Debit") echo "<option value='Debit' selected>Debit</option>";
                                            else echo "<option value='Debit'>Debit</option>";

                                            if ($bt->jenis == "Kredit") echo "<option value='Kredit' selected>Kredit</option>";
                            ...
                            foreach ($kredit_bt as $kredit) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                      ...
                                      <?php include "edit_kredit_jl.php" ?>
