...
foreach ($marketing as $ang) {
    ...
    foreach ($marketing as $ang_2) {
       if ($ang_2->id_mar == $up_ang ) {
           ...
           foreach ($tampil_jabatan as $jabatan) {
               if ($jabatan->id_jabatan == $ang_2->jabatan_mar) {
                   $jabatan_up_ang = $jabatan->nilai_jabatan;
               }
           }

           //$jabatan_up_ang = $ang_2->nilai_jabatan_mar;
   ...
   foreach ($marketing as $ang_3) {
       if ($ang_3->id_mar == $up2_ang ) {
           ...
           foreach ($tampil_jabatan as $jabatan) {
               if ($jabatan->id_jabatan == $ang_3->jabatan_mar) {
                   $jabatan_up2_ang = $jabatan->nilai_jabatan;
               }
           }

           //$jabatan_up2_ang = $ang_3->nilai_jabatan_mar;
...
foreach ($marketing as $fran) {
    ...
    foreach ($marketing as $fran_2) {
       if ($fran_2->id_mar == $up_fran ) {
           ...
           foreach ($tampil_jabatan as $jabatan) {
               if ($jabatan->id_jabatan == $fran_2->jabatan_mar) {
                   $jabatan_up_fran = $jabatan->nilai_jabatan;
               }
           }

           //$jabatan_up_fran = $fran_2->nilai_jabatan_mar;
   ...
   foreach ($marketing as $fran_3) {
       if ($fran_3->id_mar == $up2_fran ) {
           ...
           foreach ($tampil_jabatan as $jabatan) {
               if ($jabatan->id_jabatan == $fran_3->jabatan_mar) {
                   $jabatan_up2_fran = $jabatan->nilai_jabatan;
               }
           }

           //$jabatan_up2_fran = $fran_3->nilai_jabatan_mar;
...
foreach ($marketing as $win) {
    ...
    foreach ($marketing as $win_2) {
       if ($win_2->id_mar == $up_win ) {
           ...
           foreach ($tampil_jabatan as $jabatan) {
               if ($jabatan->id_jabatan == $win_2->jabatan_mar) {
                   $jabatan_up_win = $jabatan->nilai_jabatan;
               }
           }

           //$jabatan_up_win = $win_2->nilai_jabatan_mar;
   ...
   foreach ($marketing as $win_3) {
       if ($win_3->id_mar == $up2_win ) {
           ...
           foreach ($tampil_jabatan as $jabatan) {
               if ($jabatan->id_jabatan == $win_3->jabatan_mar) {
                   $jabatan_up2_win = $jabatan->nilai_jabatan;
               }
           }

           //$jabatan_up2_win = $win_3->nilai_jabatan_mar;
