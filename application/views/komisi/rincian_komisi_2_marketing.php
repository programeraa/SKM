    ...
    <?php if ($komisi->status_komisi == "Approve") { ?>
        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        <label for="jenis_hitungan_komisi" class="col-form-label">Jenis Hitungan Komisi</label>
                        <input type="text" class="form-control" id="jenis_hitungan_komisi" name="jenis_hitungan_komisi" value="<?= $komisi->jenis_hitungan_komisi ?>" readonly>
                    </div>
                    <div class="form-group">
            ...
            <div class="row">
                <div class="col">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <?php if (($komisi->mar_listing_komisi == 77 && !empty($s_cobroke)) || ($komisi->mar_listing_komisi == 77)){?>

                                <?php if ($komisi->mar_listing_komisi == 77 && empty($s_cobroke)){ ?>
                                    <td class="tg-0lax "><?php echo 'Fee Listing/Kantor'?> - <?= $komisi->nama_mar ?></td>
                                <?php }else{ ?>
                            ...
                            <?php if (($komisi->mar_selling_komisi == 77 && !empty($j_cobroke)) || ($komisi->mar_selling_komisi == 77)){?>

                                <?php if ($komisi->mar_selling_komisi == 77 && empty($j_cobroke)){ ?>
                                    <td class="tg-0lax "><?php echo 'Fee Selling/Kantor'?> - <?= $komisi->nama_mar2 ?></td>
                                <?php }else{ ?>
                        ...
                        <tr>
                            ...
                            <?php }else{ ?>
                                ...
                                <?php if (($komisi->mar_listing_komisi == 77 && !empty($s_cobroke)) || ($komisi->mar_selling_komisi == 77 && !empty($j_cobroke))|| ($komisi->mar_listing_komisi == 77)){?>
                            ...
                            <?php }else{ ?>
                                ...
                                <?php if (($komisi->mar_listing_komisi == 77 && !empty($s_cobroke)) || ($komisi->mar_selling_komisi == 77 && !empty($j_cobroke)) || ($komisi->mar_selling_komisi == 77)){?>
                        ...
                        <?php if (!empty($m_listing_2 || $m_selling_2)) { ?>
                            ...
                            <tr>
                                <?php if ($komisi->mar_listing2_komisi == 77){ ?>
                                    <td class="tg-0lax"><?php echo 'Marketing Listing Ke 2 - '.$komisi->listing_2?></td>
                                ...
                                <?php if ($komisi->mar_selling2_komisi == 77){ ?>
                                    <td class="tg-0lax "><?php echo 'Marketing Selling Ke 2 - '.$komisi->selling_2?></td>
        ...
        <table class="tg table table-striped table-dark">
            ...
            <?php }else{ ?>
                ...
                <?php }else{ ?>
                    ...
                    <?php }else{ ?>
                        <?php if ($komisi->mar_selling_komisi == 77){ ?>
                            <table class="tg table table-striped table-dark">
                                <tbody>
                                  <tr>
                                    <td class="tg-0lax"><?php echo 'Fee Marketing'?></td>
