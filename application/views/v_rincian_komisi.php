        ...
        <div class="d-flex justify-content-between mb-2">
            <div class="text-right">
                ...
                <?php }else{ ?>
                    ...
                    <a href="<?= base_url('komisi/komisi_print/' . $komisi->id_komisi); ?>" target ="_blank" class="btn btn-primary mb-2 ml-2" title="Print Rincian"><i class="fas fa-print"></i></a> 
                <?php } ?>
            </div>

            <div class="text-right">
                <p class="text-danger font-weight-bold">Closing : <?= date("d-m-Y", strtotime($komisi->tgl_closing_komisi))?> - <span class="text-dark">Tanggal Input : <?= date("d-m-Y", strtotime($komisi->waktu_komisi))?>/<?= $komisi->nama_pengguna ?> (<?= $pengguna_level ?>)</span>
                </div>
            </div>
                                ...
                                <?php if (!empty($referal_keterangan)) {?>
                                    <?php if (strlen($referal_jumlah) <= 2) {?>
                                        <?php if (!empty($kubruk_nama)) {?>
                                            <input type="text" name="fee_referal" value="<?= $hitung_referal_baru ?>">
                                            <input type="text" name="pph_referal" value="<?= $pajak_ref_1 ?>">
                                        <?php }else{ ?>
                                            <input type="text" name="fee_referal" value="<?= $hitung_referal ?>">
                                            <input type="text" name="pph_referal" value="<?= $pajak_ref_2 ?>">
                                        <?php } ?>
                                    <?php }else{ ?>
                ...
                <div class="card-body p-0">
                    <div class="card text-center w-50 mx-auto my-auto">
                        ...
                        <div class="card-body">
                            ...
                            <a href="#" class="btn btn-primary"><?= $komisi->admin_disetujui ?> - <?= $disetujui_level ?></a>
                        </div>
