                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <br>
                                        <?php if ($gambar_ktp == 1) { ?>
                                            <img src="<?= base_url('assets/foto_marketing/' . $mkt->gambar_ktp_mar) ?>" alt="Gambar KTP" width="200">
                                        <?php }else{ ?>
                                            <img src="<?= base_url('assets/foto_marketing/tidak_ada.jpg') ?>" alt="Gambar KTP" width="250">
                                        <?php } ?>
                                        <br>
                                        <br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <?php if ($gambar_npwp == 1) { ?>
                                            <img src="<?= base_url('assets/foto_marketing/' . $mkt->gambar_npwp_mar) ?>" alt="Gambar NPWP" width="200">
                                        <?php }else{ ?>
                                            <img src="<?= base_url('assets/foto_marketing/tidak_ada.jpg') ?>" alt="Gambar KTP" width="250">
                                        <?php } ?>
                                        <br>
