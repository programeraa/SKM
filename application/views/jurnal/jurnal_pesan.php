                ...
                foreach ($jurnal_pesan as $pesan) { 
                    ...
                    <tr>
                     ...
                     <?php }else{ ?>
                        ...
                        <a href="<?= base_url('jurnal/hapus_pesan/' . $pesan->id_pesan); ?>" onclick="javascript:return confirm('Apakah Anda yakin ingin menghapus data pesan?')" class="btn btn-danger"><i class="fas fa-trash" title="Hapus"></i></a>
