                ...
                <table id="myTable" class="myTable table table-bordered table-striped">
                    ...
                    <tbody>
                        ...
                        foreach ($jurnal_umum as $jurnal) {
                            ...
                            <tr>
                                <td>
                                    <a href="<?= base_url('jurnal/edit_jurnal/' . $jurnal->id_jurnal.'?Kojur='.$jurnal->kode_jurnal.'&Asal=TJL'); ?>" class="btn btn-success btn-sm" data-target="#editModal"><i class="fas fa-edit" title="Edit Jurnal"></i></a>
