 <div class="container pt-5 pb-5">
    <div class="d-flex justify-content-between mb-2">
        ...
        <div class="text-right">
            ...
            <?php }elseif(isset($_GET['Asal'])){ ?>
                <a href="<?= base_url('jurnal/tambah_jurnal_lanjutan/'.$_GET['Kojur']);?>" class="btn btn-secondary mb-2"><i class="fas fa-home"></i></a>
            <?php }else{ ?>
        ...
        foreach ($jurnal_umum as $jurnal) { ?>
            ...
            <div class="card-body">
                <form method="post" action="<?= base_url('Jurnal/update_jurnal'); ?>" enctype="multipart/form-data">
                    ...
                    <?php if(isset($_GET['Asal'])){ ?>
                        <input type="hidden" name="asal_jurnal" value="<?= $_GET['Kojur'] ?>">
                    <?php } ?>
                    ...
                    <div class="modal-footer pr-0">
                        ...
                        <?php }else{ ?>
                            <button type="submit" name="submit_type" value="tjl" class="btn btn-primary">Submit & Kembali</button>
                        <?php } ?>
                    </div>
                </form>
