            ...
            <div class="modal-body">
                <form method="post" action="<?= base_url('Jurnal/update_jurnal'.'?from='.$jurnal->kode_jurnal); ?>" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <!-- <input type="text" class="form-control" name="tampil_nominal" id="tampil_nominal" value="<?= $jurnal->nominal_jurnal ?>" onkeyup="formatRupiahModal(this, 'nominal')">

                        <input type="hidden" class="form-control" id="nominal" name="nominal" value="<?= $jurnal->nominal_jurnal ?>"> -->

                        <input type="text" class="form-control" name="tampil_nominal" id="tampil_nominal" value="<?= $jurnal->nominal_jurnal ?>" onkeyup="formatRupiahModal(this, 'nominal', <?= $jurnal->id_jurnal ?>)">
                        
                        <input type="hidden" class="form-control" id="nominal_<?= $jurnal->id_jurnal ?>" name="nominal" value="<?= $jurnal->nominal_jurnal ?>">
