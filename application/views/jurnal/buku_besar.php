        ...
        <tbody>
            ...
            foreach ($jurnal_umum as $jurnal) { 
                ...
                if(isset($_GET['dari']) && isset($_GET['ke']) || isset($_GET['kode_per']) || isset($_GET['j_kode'])) {
                    ...
                    if (($k == 'UTJ' || $_GET['j_kode'] == 'UTJ') || ($_GET['kode_per'] == 164 || $_GET['kode_per'] == 183 || $_GET['kode_per'] == 163 || $_GET['kode_per'] == 178 || $_GET['kode_per'] == 241) || (($k == 801 && in_array($n, [100, 101, 104, 105, 106, 107])) || ($k == 101 && in_array($n, [1, 2, 3, 4, 5])))) {
