    ...
    <table id="myTable" class="table table-bordered table-striped">
        ...
        <tbody>
            ...
            foreach ($jurnal_bttb as $jurnal) { 
                ...
                foreach ($jurnal_umum as $umum) {
                    if ($umum->id_bttb == $jurnal->id_bttb) {
                        $check = true;
                    }
                }

                foreach ($tampil_pengguna as $pengguna) {
                   if ($pengguna->id_pengguna == $jurnal->admin_input) {
               ...
               <tr>
                ...
                <td>
                    <?php if ($level_asli != 'CMO') {?>
                        ...
                        <?php if (!$check) { ?>
                            <a href="<?= base_url('jurnal/hapus_bttb/' . $jurnal->id_bttb); ?>" onclick="javascript:return confirm('Apakah Anda yakin ingin menghapus data akun ?')" class="btn btn-danger"><i class="fas fa-trash" title="Hapus"></i></a>
                        <?php } ?>
                    <?php } ?>
                </td>
            </tr>
