...
<div class="container pt-5 pb-5">
    ...
    <div class="card">
        <div class="card-header bg-dark text-white">
            ...
            ?>
            <h4 class="card-title" style="text-align: center;">Saldo UTJ</h4>
            <?php if ($b != null){ ?>
                <h5>
                  <?php 
      ...
      <div class="card-body">
        <div class="pb-3 d-sm-flex justify-content-start">
            <form method="get" action="<?= base_url('jurnal/filterSaldoUTJ'); ?>">
    ...
    <div class="table-responsive">
        <table id="myTable" class="table table-bordered table-striped">
            ...
            <tbody>
                ...
                foreach ($total_biaya as $biaya) { 
                    ...
                    <tr>
                        ...
                        <td>
                            <?php 
                            if ($biaya->keterangan_jurnal == 'Koreksi Saldo') {
                        ...
                        <td><?php 
                        if ($biaya->keterangan_jurnal == 'Koreksi Saldo') {
                            echo "<span class='badge badge-primary p-2'>".$biaya->keterangan_jurnal."</span>";
                        }else{
                            echo $biaya->keterangan;
                        }?></td>
                        <td>
                            <?php
                            if ($biaya->keterangan_jurnal == 'Koreksi Saldo') {
                                echo numberToRupiah2($biaya->nominal_jurnal);
                                $koreksi_saldo = $biaya->nominal_jurnal;
                            }else{
                                $total_nominal = 0;
                                ...
                                echo numberToRupiah2($total_nominal);
                            }

                            $total_saldo_akhir_fix = $total_saldo_akhir + $koreksi_saldo;
            ...
            <tfoot>
                ...
                <th></th>
                <th></th>
                <th><?= numberToRupiah2($total_saldo_akhir_fix)  ?></th>
            </tfoot>
        </table>
    </div>
</div>
